...
import FeedItemParticipantsCell from 'src/components/FeedItemParticipant/FeedItemParticipantsCell'
...
export const initialColumns = [
  {
    ...
    filterOut,
    link: (givenId) => {
      return routes.feedItemParticipant({ id: givenId })
    },
    dataType: 'integer',
  },
...
const FeedItemParticipantsList = () => {
  ...
  let roles = {
    createRecord: 'feeditemparticipantCreate',
    updateRecord: 'feeditemparticipantUpdate',
    deleteRecord: 'feeditemparticipantDelete',
  }

  return (
    <Fragment>
      <FeedItemParticipantsCell
        orderBy={orderBy}
...
export default FeedItemParticipantsList
