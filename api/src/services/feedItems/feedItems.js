...
export const createFeedItem = async ({ input }) => {
  try {
...
export const feedItems = async ({ filter, skip, orderBy, q, take }) => {
  try {
...
export const feedItem = async ({ id }) => {
  try {
...
export const updateFeedItem = async ({ id, input }) => {
  try {
...
export const FeedItem = {
  ...
  feed: (_obj, { root }) =>
    db[table].findUnique({ where: { id: root.id } }).feed(),
}
